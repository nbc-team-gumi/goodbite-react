...
# Copy SSL certificates generated by GitHub Actions
COPY goodbite.site-key.pem /app/goodbite.site-key.pem
COPY goodbite.site-crt.pem /app/goodbite.site-crt.pem
